...
{theme_css}
    ...
    * {{ box-sizing: border-box; margin: 0; padding: 0; }}
    ...
    /* 3-Card Fanned Amphitheater Stage (Wireframe Diagram Layout) */
    .thesis-fanned-stage {{
      display: flex;
      justify-content: center;
      align-items: center;
    ...
    /* Left card: angled counter-clockwise, pointing inward */
    .thesis-card-left {{
      transform: rotate(-12deg) translateY(24px) translateX(20px);
      z-index: 2;
      transform-origin: bottom right;
    }}

    .thesis-card-left.chronos-revealed {{
      transform: rotate(-12deg) translateY(24px) translateX(20px) !important;
    }}

    /* Center card: straight, elevated, foreground */
    .thesis-card-center {{
      transform: rotate(0deg) translateY(-14px);
      z-index: 5;
      box-shadow: 0 22px 50px -10px rgba(0, 0, 0, 0.15), 0 6px 18px rgba(0, 0, 0, 0.06);
      border-color: rgba(0, 0, 0, 0.14);
    }}

    .thesis-card-center.chronos-revealed {{
      transform: rotate(0deg) translateY(-14px) !important;
    }}

    /* Right card: angled clockwise, pointing inward */
    .thesis-card-right {{
      transform: rotate(12deg) translateY(24px) translateX(-20px);
      z-index: 2;
    ...
    .thesis-card-right.chronos-revealed {{
      transform: rotate(12deg) translateY(24px) translateX(-20px) !important;
    }}

    /* Interactive hover lift: smoothly levels out and lifts up on hover */
    .thesis-fanned-card:hover {{
      transform: translateY(-20px) rotate(0deg) scale(1.04) !important;
      z-index: 10 !important;
      box-shadow: 0 26px 58px -10px rgba(0, 0, 0, 0.2), 0 10px 24px rgba(0, 0, 0, 0.08) !important;
    ...
    /* Audited Statistical KPI Cross-Grid Showcase (Retained Editorial Canvas) */
    ...
    .kpi-card:hover {{
      ...
      box-shadow: 0 14px 30px rgba(0, 0, 0, 0.08), 0 2px 8px rgba(0, 0, 0, 0.04);
    ...
    .kpi-card-center-bottom {{
      box-shadow: 0 10px 26px rgba(0, 0, 0, 0.06), 0 2px 6px rgba(0, 0, 0, 0.03);
    }}

    /* Stagger reveal transitions */
    .kpi-card[data-stagger-index="0"] {{
      transition-delay: 0ms;
    }}
    .kpi-card[data-stagger-index="1"] {{
      transition-delay: 140ms;
    }}
    .kpi-card[data-stagger-index="2"] {{
      transition-delay: 280ms;
    }}
    .kpi-card[data-stagger-index="3"] {{
    ...
    /* Scroll-Pinned Guardrails Spread Stage */
    .guardrails-pinned-stage {{
      position: relative;
      height: 235vh;
      background-color: var(--color-white);
      background-image: radial-gradient(circle at 50% 50%, rgba(16, 185, 129, 0.04) 0%, rgba(24, 24, 27, 0.01) 40%, transparent 75%);
    }}

    .guardrails-sticky-window {{
      position: sticky;
      top: 0;
      left: 0;
      width: 100%;
    ...
    .guardrails-ambient-glow {{
      ...
      width: 440px;
      height: 280px;
      background: radial-gradient(ellipse at center, rgba(16, 185, 129, 0.12) 0%, rgba(52, 211, 153, 0.04) 45%, transparent 75%);
      pointer-events: none;
      z-index: 0;
      border-radius: 50%;
      filter: blur(30px);
    ...
    .guardrails-spread-card:hover {{
      transform: translateY(-4px) !important;
      box-shadow: 0 16px 36px -4px rgba(0, 0, 0, 0.09), 0 4px 12px rgba(0, 0, 0, 0.03) !important;
      border-color: rgba(0, 0, 0, 0.2) !important;
    }}

    .guardrails-card-head {{
      display: flex;
      justify-content: space-between;
      align-items: center;
    ...
    .guardrails-card-foot .foot-status {{
      color: var(--color-green);
      font-weight: 700;
    }}
...
<body>
  ...
  <section class="section-spacious" id="thesis">
    <div class="container">
      ...
      <div class="thesis-fanned-stage">
        <!-- Card 1: Left Angled -->
        <div class="thesis-fanned-card thesis-card-left card-paper" data-stagger-index="0">
          <div class="step-index">01 /</div>
          <h3 style="font-family: var(--font-serif-editorial); font-size: 1.18rem; margin-bottom: 0.45rem; color: var(--color-black);">The Shuttered Exchange</h3>
          <p style="font-size: 0.9rem; color: var(--color-grey-text); line-height: 1.6; margin: 0;">
        ...
        <div class="thesis-fanned-card thesis-card-center card-paper" data-stagger-index="1">
          <div class="step-index">02 /</div>
          <h3 style="font-family: var(--font-serif-editorial); font-size: 1.18rem; margin-bottom: 0.45rem; color: var(--color-black);">Retail Drift & Noise</h3>
          <p style="font-size: 0.9rem; color: var(--color-grey-text); line-height: 1.6; margin: 0;">
        ...
        <!-- Card 3: Right Angled -->
        <div class="thesis-fanned-card thesis-card-right card-paper" data-stagger-index="2">
          <div class="step-index">03 /</div>
          <h3 style="font-family: var(--font-serif-editorial); font-size: 1.18rem; margin-bottom: 0.45rem; color: var(--color-black);">Institutional Convergence</h3>
          <p style="font-size: 0.9rem; color: var(--color-grey-text); line-height: 1.6; margin: 0;">
  ...
  <section class="kpi-showcase-section" id="metrics">
    <div class="container">
      <div class="kpi-cross-stage">
        ...
        <div class="kpi-card kpi-card-left card-paper stat-box-interactive" data-stagger-index="0">
        ...
        <div class="kpi-center-stack">
          ...
          <div class="kpi-card kpi-card-center-top card-paper stat-box-interactive" data-stagger-index="1">
          ...
          <div class="kpi-card kpi-card-center-bottom card-paper stat-box-interactive" data-stagger-index="2">
        ...
        <div class="kpi-card kpi-card-right card-paper stat-box-interactive" data-stagger-index="3">
  ...
  <!-- 4 Core Quantitative Guardrails: Scroll-Pinned Spread Section -->
  <section class="guardrails-pinned-stage" id="guardrails">
    <div class="guardrails-sticky-window" id="guardrailsStickyWindow">
      <div class="container guardrails-stage-content">
        
        <!-- Header -->
        <div class="guardrails-header" style="text-align: center; max-width: 780px; margin: 0 auto 1.75rem auto;">
          <div class="section-tag" style="justify-content: center; margin: 0 auto 0.65rem auto;">
            <span class="section-tag-dot"></span>
            <span>INSTITUTIONAL GUARDRAILS</span>
          </div>
          <h2 class="section-title" style="margin-bottom: 0.45rem;">Engineered Defenses & Risk Control</h2>
          <p class="section-desc" style="margin: 0 auto; max-width: 650px;">
        ...
        <!-- 2x2 Spread Grid Canvas -->
        <div class="guardrails-spread-canvas" id="guardrailsSpreadCanvas">
          <!-- Ambient Glow in the Center matching Image 2 -->
          <div class="guardrails-ambient-glow" aria-hidden="true"></div>

          <!-- Top-Left Card Slot: Beta Decoupling -->
          <div class="guardrails-card-slot slot-tl" data-slot="tl" data-stagger-index="0">
            <div class="card-paper guardrails-spread-card">
              <div>
                <div class="guardrails-card-head">
                  <div class="guardrails-icon-badge">
                  ...
                  <span class="guardrails-tech-tag">BETA ESTIMATION</span>
                </div>
                <h4 class="guardrails-card-title">Beta Decoupling</h4>
                <p class="guardrails-card-desc">
              ...
              <div class="guardrails-card-foot">
                <span>FORMULA: ε_i = R_i - β_i · R_BTC</span>
                <span class="foot-status">LOCKED</span>
              </div>
            </div>
          </div>

          <!-- Top-Right Card Slot: Closed-Loop Self-Auditor -->
          <div class="guardrails-card-slot slot-tr" data-slot="tr" data-stagger-index="1">
            <div class="card-paper guardrails-spread-card">
              <div>
                <div class="guardrails-card-head">
                  <div class="guardrails-icon-badge">
                  ...
                  <span class="guardrails-tech-tag">CLOSED-LOOP AUDIT</span>
                </div>
                <h4 class="guardrails-card-title">Closed-Loop Self-Auditor</h4>
                <p class="guardrails-card-desc">
                  Diagnoses trade outcomes (Momentum Overrun, Decoupling, Latency) and automatically adapts entry Z-thresholds into memory.
                </p>
              </div>
              <div class="guardrails-card-foot">
                <span>ADAPTIVE MEMORY BARRIER</span>
                <span class="foot-status">ACTIVE</span>
              </div>
            </div>
          </div>

          <!-- Bottom-Left Card Slot: Bitget HMAC Gateway -->
          <div class="guardrails-card-slot slot-bl" data-slot="bl" data-stagger-index="2">
            <div class="card-paper guardrails-spread-card">
              <div>
                <div class="guardrails-card-head">
                  <div class="guardrails-icon-badge">
                  ...
                  <span class="guardrails-tech-tag">REST & MCP ENDPOINTS</span>
                </div>
                <h4 class="guardrails-card-title">Bitget HMAC Gateway</h4>
                <p class="guardrails-card-desc">
              ...
              <div class="guardrails-card-foot">
                ...
                <span class="foot-status">SECURE</span>
              </div>
            </div>
          </div>

          <!-- Bottom-Right Card Slot: Monday Cash Convergence -->
          <div class="guardrails-card-slot slot-br" data-slot="br" data-stagger-index="3">
            <div class="card-paper guardrails-spread-card">
              <div>
                <div class="guardrails-card-head">
                  <div class="guardrails-icon-badge">
                  ...
                  <span class="guardrails-tech-tag">ZERO EQUITY BETA</span>
                </div>
                <h4 class="guardrails-card-title">Monday Cash Convergence</h4>
                <p class="guardrails-card-desc">
                  Guarantees all active weekend positions are automatically flattened back to 100% USDT before 09:30 EST Monday, eliminating NYSE open gap risk.
                </p>
              </div>
              <div class="guardrails-card-foot">
                <span>DEADLINE: 09:30 EST</span>
                <span class="foot-status">AUTOMATED</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    // Scroll-Pinned 2x2 Guardrails Spread Controller
    function initGuardrailsSpread() {{
      const stage = document.getElementById("guardrails");
      if (!stage) return;
      ...
      function updateSpread() {{
        ...
        // Compute normalized progress 0.0 -> 1.0 through the pinned stage
        ...
        // Responsive spread offsets from central cluster to 2x2 grid positions
        const canvas = document.getElementById("guardrailsSpreadCanvas");
        const canvasWidth = canvas ? canvas.offsetWidth : 980;
    ...
    function initIndexApp() {{
      ...
      try {{ initGuardrailsSpread(); }} catch(e) {{}}
      setTimeout(() => {{
        const pri = document.querySelector(".page-rise-in");
        if (pri) {{
          pri.style.animation = "none";
          pri.style.transform = "none";
          pri.style.filter = "none";
        }}
      }}, 750);
    }}
