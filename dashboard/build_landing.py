    ...
    <div class="guardrails-sticky-window" id="guardrailsStickyWindow">
      <div class="container guardrails-stage-content">
        ...
        <div class="guardrails-spread-canvas" id="guardrailsSpreadCanvas">
          ...
          <!-- Bottom-Right Card Slot: Multi-Wallet Isolation -->
            ...
            <div class="card-paper guardrails-spread-card">
              <div>
                <div class="guardrails-card-head">
                  ...
                  <span class="guardrails-tech-tag">ZERO GHOST TRADES</span>
                </div>
                <h4 class="guardrails-card-title">Multi-Wallet Isolation</h4>
                <p class="guardrails-card-desc">
                  Strict per-wallet state isolation, zero ghost trades when disconnected, single-stock position caps, and dynamic stop losses.
                </p>
              </div>
              <div class="guardrails-card-foot">
                <span>CAP: 1 POS / ASSET</span>
                <span class="foot-status">ENFORCED</span>
              </div>
            </div>
          </div>
        </div>
