      ...
      <div id="viewArena" style="display: none;">
        ...
        <div class="arena-grid-split">
          ...
          <div class="arena-card" style="display: flex; flex-direction: column; gap: 0.85rem;">
            ...
            <div style="background: #FFFFFF; border: 1px solid #EEE9DF; border-radius: 8px; padding: 0.55rem 0.75rem;">
              <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.25rem;">
                <span style="font-size: 0.68rem; color: #71717A; font-family: var(--font-terminal);">Weekend Cap Quota</span>
                <span style="font-size: 0.68rem; font-weight: 700; color: #10B981; font-family: var(--font-terminal);">3 / 5 Deployed</span>
              </div>
              ...
              <div style="font-size: 0.65rem; color: #71717A; margin-top: 0.35rem;">
                Trades execute sequentially when mathematical drift clears (|Z| ≥ 2.0σ).
              </div>
            </div>
  ...
  <script>
    ...
    const ChronosWalletStore = {{
      ...
      syncActiveView() {{
        ...
        // Dynamic Sidebar Wallet Synchronization
        ...
        if (this.currentAddress) {{
          ...
          if (bLabel) bLabel.textContent = "Bound: " + shortAddr;
          if (sDot) {{ sDot.style.color = "#10B981"; sDot.textContent = "●"; }}
        }} else {{
          if (uLabel) uLabel.textContent = "Sandbox Mode";
          if (bLabel) bLabel.textContent = "No Wallet Connected";
          if (sDot) {{ sDot.style.color = "#F59E0B"; sDot.textContent = "●"; }}
        }}
