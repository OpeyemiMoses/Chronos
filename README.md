...
### Live Deployments & Public Endpoints
* **Web3 Trading Terminal (Vercel Edge):** [https://chronos-hours.vercel.app/terminal](https://chronos-hours.vercel.app/terminal)
* **Full-Stack Application & API Gateway (Railway):** [https://chronos-production-a1e4.up.railway.app/terminal](https://chronos-production-a1e4.up.railway.app/terminal)
...
* **Real Bitget Candlestick Backtest Data:** [`data/real_backtest_results.json`](data/real_backtest_results.json)
