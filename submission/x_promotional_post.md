# Compliant X (Twitter) Promotional Post Guide
...
1. Open this official tweet on X: **https://x.com/Bitget_AI/status/2100519318824055159?s=20**
2. Click **Quote Tweet** (or Retweet with Quote).
3. Paste the copy below into your quote tweet.
4. Publish the tweet.
5. Copy the link of your published tweet and paste it into the **"X Promotional Post Link"** field in the Google Form!

---

### Tweet Copy (Ready to Paste):

```text
When traditional US markets halt for 65 hours every weekend, tokenized stocks trade 24/7. 
...
3️⃣ Pre-Trade Strategy Clearance Engine verifies |Z| >= 2.0σ & risk-parity bounds before order dispatch.
